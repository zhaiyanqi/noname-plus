...
public class AnimatorUtil {
    ...
    public static ValueAnimator getAlphaAnimator(float from, float to, int duration) {
    ...
    public static ValueAnimator getAlphaAnimator(float from, float to) {
        return getAlphaAnimator(from, to, DURATION_ALPHA);
    }

    public static ValueAnimator getScaleAnimator(float from, float to) {
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(from, to);
