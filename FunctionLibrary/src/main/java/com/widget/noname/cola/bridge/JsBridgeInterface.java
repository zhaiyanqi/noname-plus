...
public class JsBridgeInterface {
    public static final String ROOT_URI = "file:///android_asset/js/start.html";

    public static final String HTTPS_ROOT_URI = "https://localhost/android_asset/js/start.html";
